...
<%
	...
	//dto list에 담아둔 getMyData 가져오기
	List<VelogDto> list=dao.getMyData(writer);
	
	//totalCount 가져오기
	int totalCount=dao.getMyBoardCount(writer);
...
<body>
	        ...
	        <div style="display: flex; justify-content: flex-end;">
		        ...
		        <div class="dropdown">
		        	<button type="button" class="dropdown-toggle" data-bs-toggle="dropdown">
				        <img src="../image/user_default.png" width="37" height="37" style="border-radius:50px;">
	...
	<div style="margin-top: 180px; height: 1000px;">
		...
		<div class="totcount">
		<span>총 <%=totalCount %> 개의 게시글이 있습니다</span>
