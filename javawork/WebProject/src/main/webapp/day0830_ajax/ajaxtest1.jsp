...
<body>
	...
	<br><br>
	<button type="button" class="btn btn-outline-danger" id="btn3">data3.xml읽기</button>
	<button type="button" class="btn btn-outline-danger" id="btn4">data4.json읽기</button><br>
		...
		$.ajax({
			...
			success:function(data){
				$.each(data,function(idx,ele){
					...
					s+="HP:"+ele.hp+"<br>";
					s+="Addr:"+(ele.addr==null?"집없음":ele.addr)+"<br><br>";
				});
