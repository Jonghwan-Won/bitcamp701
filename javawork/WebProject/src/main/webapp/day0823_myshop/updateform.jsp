...
<%
	...
	//가장 중요한 한가지
	//폼 안에 반드시 (읽어온)num을 hidden으로 넣어줘야한다 (수정 시 가장 중요)
			...
			<table class="table table-bordered" style="width: 400px;">
				...
				<tr>
					...
					<td>
						...
						<!-- img src 로 이미지를 넣게되면 form-control 의 영향을 받아 아래로 나오게됨 -->
						<!-- div input group 으로 묶어서 옆으로 나오게함 -->
				...
				<tr>
					...
					<td>
						...
						class="form-control" style="width: 100px" value="<%=dto.getColor()%>">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						class="form-control" pattern="[0-9]{3,}" value="<%=dto.getPrice()%>">
						<!-- 0~9만 입력가능, 3글자 이상 -->
